...
import uk.ac.herts.SmartLab.MuRata.Type.CommandID;
...
public class UARTFrame {
	public static final byte SOM = 0x02;
	...
	private CommandID commandid = CommandID.ACK;
	...
	public void SetCommandID(int value) {
		this.commandid = CommandID.parse(value & 0x7F);
	}
	...
	public void SetPayload(Payload payload) {
		...
		this.SetChecksum(l0 + (needACK ? l1 | 0x40 : l1) + commandid.getValue());
	}
	...
	public void SetChecksum(int checksum) {
		this.checksum = (byte) (checksum & 0x7F);
	}

	public boolean VerifyChecksum() {
		if (((l0 + (needACK ? l1 | 0x40 : l1) + commandid.getValue()) & 0x7F) == this.checksum)
			return true;
		return false;
	}
}